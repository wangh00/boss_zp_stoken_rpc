var client_id, RPCclient = function (wsURL) {
    this.wsURL = wsURL;
    this.handlers = {
...
RPCclient.prototype.connect = function () {
    if (this.wsURL.indexOf("clientId=") === -1 && client_id) {
        this.wsURL += "&clientId=" + client_id
    }
...
RPCclient.prototype.handlerRequest = function (requestJson) {
    var _this = this;
    try {
...
RPCclient.prototype.sendResult = function (action, message_id, e) {
